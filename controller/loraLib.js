        ...
        if (format[i].total) {
            ...
            for (let j = 0; j < format[i].total; j++) {
                if (format[i].num) {
                    ...
                    //     numArr.push({
                    //         title: format[i]['detail'][k],
                    //         value: format[i]['transform'] ? hex2int(str.substr(start, end)) : str.substr(start, end)
                    //     })
                    //     start += format[i].len
                    // }
                    // totalArr.push(numArr)
                    let numArr = {};
                    for (let k = 0; k < format[i].num; k++) {
...
// endTime: 2023/10/24 16:35:49.323
// startTime: 2023/10/24 16:34:18.752
